...
public class GenerarPdf {
    ...
    public void generarPDFTaller(JTable table) {
        Document documento = new Document(PageSize.LETTER.rotate());
        ...
        try {
            ...
            String nombreArchivo = "Reporte Taller " + fechaActual + ".pdf";
            File archivo = new File(ruta + nombreArchivo);

            // Verificar si existe un archivo con el mismo nombre y añadir un número al nombre si es necesario
            int contador = 1;
            while (archivo.exists()) {
                nombreArchivo = "Reporte Taller " + fechaActual + "(" + contador + ").pdf";
                archivo = new File(ruta + nombreArchivo);
                contador++;
            }
            ...
            // Agregar título y fecha al documento
            Paragraph encabezado = new Paragraph("Reporte de Taller\n");
            encabezado.setSpacingAfter(20);
            documento.add(encabezado);
